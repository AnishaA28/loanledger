...
const LoanId = Nat;
const RepaymentId = Nat;
const Result_1 = Variant({ "ok": RepaymentId, "err": Text });
...
const Repayment = Record({
  ...
  "return_date": Text,
  "notes": Text,
  "returned_by": Principal$1
});
Service({
  "addRepayment": Func(
    [LoanId, Nat, Text, Text],
    [Result_1],
    []
  ),
  "createLoan": Func(
  ...
  "deleteLoan": Func([LoanId], [Result], []),
  "getLoan": Func([LoanId], [Opt(Loan)], ["query"]),
  "getLoans": Func([], [Vec(Loan)], ["query"]),
  "getRepayments": Func([LoanId], [Vec(Repayment)], ["query"])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const LoanId2 = IDL2.Nat;
  const RepaymentId2 = IDL2.Nat;
  const Result_12 = IDL2.Variant({ "ok": RepaymentId2, "err": IDL2.Text });
  const Result2 = IDL2.Variant({ "ok": IDL2.Null, "err": IDL2.Text });
  const LoanStatus2 = IDL2.Variant({
    "active": IDL2.Null,
    "completed": IDL2.Null
  });
  ...
  const Loan2 = IDL2.Record({
    "id": LoanId2,
    "status": LoanStatus2,
    "pending_amount": IDL2.Nat,
    "total_returned": IDL2.Nat,
    "created_at": Timestamp2,
    "amount_given": IDL2.Nat,
    "given_date": IDL2.Text,
    "notes": IDL2.Text,
    "given_by": IDL2.Principal,
    "given_to": IDL2.Text
  });
  const Repayment2 = IDL2.Record({
    "id": RepaymentId2,
    "loan_id": LoanId2,
    "amount_returned": IDL2.Nat,
    "return_date": IDL2.Text,
    "notes": IDL2.Text,
    "returned_by": IDL2.Principal
  });
  return IDL2.Service({
    "addRepayment": IDL2.Func(
      [LoanId2, IDL2.Nat, IDL2.Text, IDL2.Text],
      [Result_12],
      []
    ),
    "createLoan": IDL2.Func(
      [IDL2.Text, IDL2.Nat, IDL2.Text, IDL2.Text],
      [LoanId2],
      []
    ),
    "deleteLoan": IDL2.Func([LoanId2], [Result2], []),
    "getLoan": IDL2.Func([LoanId2], [IDL2.Opt(Loan2)], ["query"]),
    "getLoans": IDL2.Func([], [IDL2.Vec(Loan2)], ["query"]),
    "getRepayments": IDL2.Func([LoanId2], [IDL2.Vec(Repayment2)], ["query"])
  });
};
class Backend {
  ...
  async addRepayment(arg0, arg1, arg2, arg3) {
  ...
  async createLoan(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
...
function from_candid_LoanStatus_n8(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n9(_uploadFile, _downloadFile, value);
}
function from_candid_Loan_n6(_uploadFile, _downloadFile, value) {
...
function useLoan(id) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["loan", id == null ? void 0 : id.toString()],
    queryFn: async () => {
...
function useRepayments(loanId) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["repayments", loanId == null ? void 0 : loanId.toString()],
    queryFn: async () => {
